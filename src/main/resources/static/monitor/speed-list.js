layui.use(['jquery','layer','laydate','table','form','element'], function(){
	  ...
	  table.render({
	    ...
	    ,cols: [[
	      ...
	      ,{field:'key', title:'主题描述', width:100, edit: 'text'}
	      ,{field:'length', title:'消息速率(条/s)', width:120, edit: 'text', templet: function(res){
	        return '<em>'+ res.comName +'</em>'
	      }}
	      ,{field:'ip', title:'消息流量(KB/s)', width:120, edit: 'text', sort: true}
	      ,{field:'org', title:'统计时间', width:100}
	    ]]
	    ,page: true
	  });
