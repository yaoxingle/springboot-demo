layui.use('table', function(){
	  ...
	  table.render({
	    ...
	    ,cols: [[
	       {type:'numbers'}
	      ,{type:'radio'}
	      ,{field:'name', title:'消费者ID', width:80, fixed: 'left', unresize: true, sort: true}
	      ,{field:'appName', title:'中文描述', width:120, edit: 'text'}
	      ,{field:'comName', title:'公司名', width:150, edit: 'text', templet: function(res){
	        return '<em>'+ res.comName +'</em>'
	      }}
	      ,{field:'desc', title:'主题名', width:80, edit: 'text', sort: true}
